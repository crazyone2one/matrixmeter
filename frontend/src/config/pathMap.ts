                ...
                children: [
                  {
                    ...
                    route:
                      RouteEnum.SETTING_ORGANIZATION_TEMPLATE_FILED_SETTING,
                    permission: [],
                    routeQuery: {
                      type: "FUNCTIONAL",
                    },
              ...
              },
              {
                ...
                children: [
                  ...
                  },
                  {
                    ...
                    route:
                      RouteEnum.SETTING_ORGANIZATION_TEMPLATE_MANAGEMENT_WORKFLOW,
                    permission: [],
                    level: MENU_LEVEL[1],
                  },
                ],
            ...
            children: [
              {
                ...
                route:
                  RouteEnum.PROJECT_MANAGEMENT_MENU_MANAGEMENT_ERROR_REPORT_RULE,
                permission: [],
                level: MENU_LEVEL[2],
              },
            ],
          ...
          },
          {
            ...
            children: [
              ...
              },
              {
                ...
                route:
                  RouteEnum.PROJECT_MANAGEMENT_TEMPLATE_MANAGEMENT_WORKFLOW,
                permission: [],
                level: MENU_LEVEL[2],
              },
            ],
